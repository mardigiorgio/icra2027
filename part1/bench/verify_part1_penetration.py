...
Standalone:
    uv run python part1/bench/verify_part1_penetration.py
"""
...
from part1.bench.benchmarks.part1_penetration import _UNIT_CORNERS, _Geometry, _quat_rotate
from part1.bench.four_arms import build_model, make_arm, scene_dt_outer
from part1.scenes.cenic_scenes import CLUTTER_CUBE_HALF, CLUTTER_SPHERE_R
