...
Run it before any sweep whose scene or budgets changed:
    ...
    uv run python part1/bench/verify_contact_budgets.py
"""
...
from part1.bench.four_arms import ICF_MAX_RIGID_CONTACT, NCONMAX, NJMAX, build_model, make_arm, scene_dt_outer
