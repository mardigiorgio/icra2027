...
separate a sliding-contact artifact from a resting-contact one.
    ...
    uv run python part1/bench/probe_actuated_trace.py
"""
...
from part1.bench.benchmarks.part1_actuated import BOUNDARY_S, _arm
from part1.scenes.actuated_press import BOX_HALF, TIP_R, X0, ActuatedSpec, build, program
