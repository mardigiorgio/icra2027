...
Standalone:
    uv run python -m part1.bench.benchmarks.initial_conditions
    uv run python -m part1.bench.benchmarks.initial_conditions --ns 1 4 16 64 256 --tols 1e-2 1e-3 1e-4
"""
...
from part1.bench.plotting import save_fig
from part1.scenes.contact_objects import DT_OUTER, build_model_randomized, make_solver
