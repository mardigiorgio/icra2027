...
(this trace is about the shape of the cost, not its floor).
    ...
    uv run python -m part1.bench.benchmarks.part1_realtime_trace --scene hard-clutter --n 64 --horizon 5
"""
...
from part1.bench.four_arms import ExhaustionTracker, build_model, make_arm, scene_dt_outer
...
def main() -> int:
    ...
    args = p.parse_args()
    out = args.out or f"part1/bench/results/part1_realtime_trace_{args.scene}_n{args.n}.csv"
    ...
    for arm_name, knob in expanded:
        r = subprocess.run(
            [sys.executable, "-m", "part1.bench.benchmarks.part1_realtime_trace", "--scene", args.scene,
