...
fingertip into a box and slides it (part1/scenes/actuated_press.py).
...
is only comparable across artifact-free cells.
    ...
    uv run python -m part1.bench.benchmarks.part1_actuated --n 8
"""
...
from part1.bench.four_arms import (
    ExhaustionTracker,
    _make_icf,
    _make_icf_adaptive,
    _make_mujoco,
...
from part1.scenes.actuated_press import (
    BOX_HALF,
    BOX_MASS,
    GAP,
    MU,
...
def main() -> int:
    ...
    p.add_argument("--out", type=str, default="part1/bench/results/part1_actuated.csv")
                        ...
                        for knob in knobs:
                            r = subprocess.run(
                                [
                                    sys.executable,
                                    "-m",
                                    "part1.bench.benchmarks.part1_actuated",
                                    "--n",
                                    str(args.n),
                                    "--single",
                                    backend,
