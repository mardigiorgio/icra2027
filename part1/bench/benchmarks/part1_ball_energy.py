...
Standalone:
    uv run python -m part1.bench.benchmarks.part1_ball_energy
"""
...
from part1.bench.four_arms import ExhaustionTracker, build_model, make_arm
from part1.scenes.cenic_scenes import SCENES, ball_energy, ball_initial_energy
...
def main() -> int:
    ...
    p.add_argument("--out", type=str, default="part1/bench/results/part1_ball_energy.csv")
    ...
    for arm_name, knob in configs:
        ...
        try:
            r = subprocess.run(
                [sys.executable, "-m", "part1.bench.benchmarks.part1_ball_energy", "--single", arm_name, str(knob)],
