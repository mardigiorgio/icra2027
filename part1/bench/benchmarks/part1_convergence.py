...
Standalone:
    uv run python -m part1.bench.benchmarks.part1_convergence
"""
...
def _run_single(backend: str, n_sub: int, n: int, horizon: float, out_path: str) -> None:
    from part1.bench.four_arms import make_arm
...
def main() -> int:
    ...
    p.add_argument("--out", type=str, default="part1/bench/results/part1_convergence.csv")
    ...
    for backend in args.backends:
        ...
        for n_sub in LADDER:
            ...
            r = subprocess.run(
                [
                    sys.executable, "-m", "part1.bench.benchmarks.part1_convergence",
