...
Standalone:
    uv run python -m part1.bench.benchmarks.part1_workprecision --scene hard-clutter --n 1 --trials 3
"""
...
from part1.bench.four_arms import ExhaustionTracker, IterationTracker, build_model, make_arm, scene_dt_outer
...
def main() -> int:
    ...
    out = args.out or f"part1/bench/results/part1_workprecision_{args.scene}_n{args.n}.csv"
    ...
    for arm_name, knob in configs:
        ...
        for _ in range(args.trials):
            try:
                r = subprocess.run(
                    [
                        sys.executable, "-m", "part1.bench.benchmarks.part1_workprecision",
