...
`uv run python part1/bench/part1_plots.py && uv run python part1/bench/part1_tables.py`.
...
## Scenes (`part1/scenes/cenic_scenes.py`)
...
## The actuated test case (`part1/scenes/actuated_press.py`, `part1_actuated.py`)
