...
# the resting ball sinks by m*g/k (part1/bench/results/tables/mujoco_stiffness_probe.md).
...
class SceneSpec:
    ...
    # (part1/bench/results/tables/mujoco_stiffness_probe.md); MuJoCo clamps
