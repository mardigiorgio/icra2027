...
Design from the literature review (part1/bench/results/PART1_LITERATURE.md,
...
import newton
from part1.scenes.cenic_scenes import CLUTTER_HC_DISSIPATION, CONTACT_MARGIN, MUJOCO_TAU_K1E5
