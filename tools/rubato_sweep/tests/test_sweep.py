"""CPU-only tests for the sweep harness. No GPU, no Isaac Lab import.
    ...
    ~/Documents/code/IsaacLabRubato/.venv/bin/python -m pytest tools/rubato_sweep/tests -q
...
from rubato_sweep import analyze, gpu, parse  # noqa: E402
from rubato_sweep.config import ConfigError, PackingCfg, SweepCfg, VideoCfg  # noqa: E402
